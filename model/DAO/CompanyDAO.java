...
public class CompanyDAO {
	...
	public List<CompanyVO> selectAll() throws SQLException {
		List<CompanyVO> list = null;
		list = sqlSession.selectList("mapper.company.selectAllCompanyList");
		return list;
	}

	public List<CompanyVO> selectClient() {
		List<CompanyVO> list = null;
		list = sqlSession.selectList("mapper.company.selectClientList");
		return list;
	}

	public List<CompanyVO> selectSupply() {
		List<CompanyVO> list = null;
		list = sqlSession.selectList("mapper.company.selectSupplyList");
		return list;
	}
