...
<table>
	...
	<tr><td>생년월일 : </td><td><input type="text" name="birthDate" value="${employee.birthDate}"></td></tr>
	...
	<tr><td>입사년월일 : </td><td><input type="text" name="startDate" value="${employee.startDate}" readonly="readonly"></td></tr>
<!--<tr><td>퇴사년월일 : </td><td><input type="text" name="endDate" value="${employee.endDate}"></td></tr>-->
