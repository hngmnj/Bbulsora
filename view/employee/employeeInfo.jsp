...
<table>
	...
	<tr><td>생년월일 : </td><td><input type="text" name="birthDate" value='<fmt:formatDate value="${employee.birthDate}" pattern="yyyy-MM-dd" />'></td></tr>
	...
	<tr><td>입사년월일 : </td><td><input type="text" name="startDate" value='<fmt:formatDate value="${employee.startDate}" pattern="yyyy-MM-dd" />'></td></tr>
	<tr><td>퇴사년월일 : </td><td><input type="text" name="endDate" value='<fmt:formatDate value="${employee.endDate}" pattern="yyyy-MM-dd" />'></td></tr>
