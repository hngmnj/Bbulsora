...
public class DeliveryDAO {
	...
	public List<DeliveryVO> selectReqByDeliveryCode(String dlvryCd) {
		return sqlSession.selectList("mapper.delivery.selectReqByDeliveryCode", dlvryCd);
	}
	
	public List<FifoVO> selectForMultiFIFO(DeliveryVO delivery) {
		return sqlSession.selectList("mapper.delivery.selectForMultiFIFO", delivery);
	}

	public List<FifoVO> selectForSingleFIFO(Map<String, Object> data) {
		return sqlSession.selectList("mapper.delivery.selectForSingleFIFO", data);
	}
}