...
요청일<input type="date" name="fromDate" value="${fromDate}">&nbsp;~&nbsp;<input type="date" name="toDate" value="${toDate}">&nbsp;
<input type="submit" value="검색" onclick="return checkInput()">
</form>
</div>
<div id="search_result">
<table>
<tr><th>주문코드</th><th>품목명</th><th>요청일</th><c:if test="${user.compCd eq 'ADMIN'}"><th>요청업체명</th></c:if></tr>
