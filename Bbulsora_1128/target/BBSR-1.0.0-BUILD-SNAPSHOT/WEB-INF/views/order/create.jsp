...
대분류<select id="major"><option value="">선택안함</option><c:forEach var="item" items="${itemList}"><option value="${item.major}">${item.major}</option></c:forEach></select>&nbsp;&nbsp;
<span id="middle_list">중분류<select id='middle'><option value="">선택안함</option></select>&nbsp;&nbsp;</span>
<span id="minor_list">소분류<select id='minor'><option value="">선택안함</option></select>&nbsp;&nbsp;</span>
<input type="text" id="searchText" >&nbsp;<input type="button" value="검색" id="btn_srchItem">
</div>

<div id="search_result" style="overflow:auto; height: 250px">
<table>
<tr><th>품목코드</th><th>품목명</th><th>공급사명</th><th>관리</th></tr>
</table>
</div>
<br/>

<div id="order_list" style="overflow:auto; text-align: center; height: 250px">
<table>
<tr><th>품목코드</th><th>품목명</th><th>공급사명</th><th>수량</th><th>단위</th><th>관리</th></tr>
</table>
</div>
